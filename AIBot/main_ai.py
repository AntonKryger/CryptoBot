...
class CryptoBotAI:
    def __init__(self, config_path=None):
        ...
        self.scan_offset = self.config.get("trading", {}).get("scan_offset_seconds", 0)
    ...
    def start(self):
        ...
        # Apply scan offset to stagger API calls across variants
        if self.scan_offset > 0:
            logger.info(f"Scan offset: venter {self.scan_offset}s før første scan")
