...
class BaseExchangeAdapter(ABC):
    ...
    def get_orderbook(self, epic: str, depth: int = 20) -> dict:
        """Get orderbook with specified depth. Override in adapters that support it."""
        raise NotImplementedError("get_orderbook not supported by this adapter")
    ...
    def fetch_open_orders(self, epic: str = None) -> list:
        """Fetch open orders, optionally filtered by epic."""
        raise NotImplementedError("fetch_open_orders not supported by this adapter")
